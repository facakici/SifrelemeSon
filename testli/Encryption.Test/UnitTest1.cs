...
namespace Encryption.Test
{
    public class Tests
    {
        ...
        [Test]
        public void Test_SPN_16_Encryption()
        {
            ...
            Assert.AreEqual(result, txtExpectedResult);
        }
        [Test]
        public void Test_SPN_16_Encryption_2()
        {
            var txtPlain = "test123";
            var txtKey = "facakici";
            var txtExpectedResult = "1010000011010110111000100101101011101011111010101010101101111010";
        ...
        public void Test_SHA_Encryption()
        {
            ...
            Assert.AreEqual(sha.encrypt(), txtExpectedResult);
        }
        [Test]
